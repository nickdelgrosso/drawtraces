...
def main():
    ...
    axTP1_cell3.plot(t_TPs[0],cell3_TP1, linewidth = 0.25, color = 'darkkhaki')
    axTP1_cell3.set_ylim(2,3)
    axTP1_cell3.axis('off')
    axTP1_cell4.plot(t_TPs[0],cell4_TP1, linewidth = 0.25, color = 'seagreen')
    axTP1_cell4.set_ylim(0.8,1.8)
    axTP1_cell4.axis('off')
    axTP1_cell5.plot(t_TPs[0],cell5_TP1, linewidth = 0.25, color = 'royalblue')
    ...
    axTP2_cell3.plot(t_TPs[1],cell3_TP2, linewidth = 0.25, color = 'darkkhaki')
    axTP2_cell3.set_ylim(2, 3)
    axTP2_cell3.axis('off')
    axTP2_cell4.plot(t_TPs[1],cell4_TP2, linewidth = 0.25, color = 'seagreen')
    axTP2_cell4.set_ylim(0.8,1.8)
    axTP2_cell4.axis('off')
    axTP2_cell5.plot(t_TPs[1],cell5_TP2, linewidth = 0.25, color = 'royalblue')
    ...
    axTP3_cell3.plot(t_TPs[2],cell3_TP3, linewidth = 0.25, color = 'darkkhaki')
    axTP3_cell3.set_ylim(2, 3)
    axTP3_cell3.axis('off')
    axTP3_cell4.plot(t_TPs[2],cell4_TP3, linewidth = 0.25, color = 'seagreen')
    axTP3_cell4.set_ylim(0.8,1.8)
    axTP3_cell4.axis('off')
    axTP3_cell5.plot(t_TPs[2],cell5_TP3, linewidth = 0.25, color = 'royalblue')
    ...
    axTP4_cell3.plot(t_TPs[3],cell3_TP4, linewidth = 0.25, color = 'darkkhaki')
    axTP4_cell3.set_ylim(2, 3)
    axTP4_cell3.axis('off')
    axTP4_cell4.plot(t_TPs[3],cell4_TP4, linewidth = 0.25, color = 'seagreen')
    axTP4_cell4.set_ylim(1,2)
    axTP4_cell4.axis('off')
    axTP4_cell5.plot(t_TPs[3],cell5_TP4, linewidth = 0.25, color = 'royalblue')
